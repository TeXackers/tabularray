...
\begin{tblr}{
  colspec = {|l||l|||l||l||},
  hline{1},
  hline{2} = {blue, leftpos = -0.8, rightpos = 0.5},
  hline{3} = {blue, leftpos = 0.5, rightpos = -0.8},
  hline{4} = {blue, leftpos = 0.3, rightpos = 0.3},
  hline{5},
}
...
\begin{tblr}{
  ...
  vline{6} = {magenta, abovepos = -0.3, belowpos = 0.7},
  vline{7} = {magenta, abovepos = 0.3, belowpos = 0.3},
  vline{8} = {magenta, abovepos = 0.7, belowpos = -0.3},
  vline{9} = {magenta, abovepos = 1, belowpos = 1},
  cell{1}{2} = {r=3}{l},
}
